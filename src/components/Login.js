    ...
    <div className="relative flex items-center justify-center h-screen bg-gray-100">
      ...
      <div className="flex shadow-lg rounded-lg bg-white max-w-4xl mx-auto">
        ...
        <div className="hidden md:flex flex-col justify-center bg-blue-50 p-10 rounded-l-lg w-1/2">
          <img src="/images/logo.png" alt="insightX Logo" className="mb-4 size-6 rounded-lg" />
          <p className="text-gray-700 text-lg">Welcome to insightX, where the future of radiology begins! We are thrilled to have you join our platform.</p>
          <div className="mt-6">
